...
@NamedQueries({
    ...
    @NamedQuery(name = "Usuario.validar", query = "SELECT u FROM Usuarios u WHERE u.logiUsua = :logiUsua and u.passUsua = :passUsua"),
...
public class Usuarios implements Serializable {
    ...
    public Usuarios(Integer codiUsua, String logiUsua, String passUsua, String email) {
        this.codiUsua = codiUsua;
